...
st.image("Screenshot_20260611-074949.png", width=60, link="https://511nl.ca/list/ferryterminalsforlist")
...
st.write('"Leg" = MV Legionnaire; "BH" = MV Beaumont-Hamel; "F" = MV Flanders; "Kam" = MV Kamutik W')
